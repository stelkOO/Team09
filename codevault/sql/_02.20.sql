...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2025. Feb 20. 13:23
...
(2, 8, 1, 1, 30, '2025-02-20'),
(3, 8, 1, 1, 30, '2025-02-20');
...
INSERT INTO `request` (`id`, `userid`, `name`, `description`, `token`) VALUES
...
(1, 'user_1', '$2y$10$fUBCjVgaGOYOpLjIfk7QV.3aVJeugdnc2.gV.sppRlw1/uPA7EOTO', '0', 'stelkooli@gmail.com', 80);
